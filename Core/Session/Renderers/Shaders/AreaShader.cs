...
public sealed class AreaShader : IDisposable
{
    public const string DefaultAssetName = "Shaders/CilliatedCell";
    ...
    public AreaShader(Effect effect, bool cloneEffect = true)
    {
    ...
    public static AreaShader Load(
        ContentManager content,
        string assetName = DefaultAssetName,
        bool cloneEffect = true)
    {
        ArgumentNullException.ThrowIfNull(content);
        return new AreaShader(content.Load<Effect>(assetName), cloneEffect);
    }
