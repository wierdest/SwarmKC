...
public sealed class PlayerAreaRenderer(SpriteBatch spriteBatch, AreaShader shader, Texture2D pixel, bool ownsShader = false) : IDisposable
{
    ...
    public PlayerAreaRenderer(SpriteBatch spriteBatch, ContentManager content, Texture2D pixel)
    ...
    public void Draw(Vector2 position, float radius, float timeSeconds)
    {
        ...
        _shader.SetBaseColor(_profile.BaseColor, _profile.BaseColorIntensity);
